...
function Divider() {
    return (
        <div style={{ display: 'flex', alignItems: 'center', padding: '4px 32px' }}>
            <div style={{ flex: 1, height: 1, background: `linear-gradient(to right, transparent, ${C.border})` }} />
            <div style={{ margin: '0 20px', display: 'flex', gap: 7, alignItems: 'center' }}>
                <div style={{ width: 4, height: 4, borderRadius: '50%', background: C.greenDark }} />
  ...
  `
    ...
    return (
        <div style={{ background: C.bg, color: C.text1, overflowX: 'hidden' }}>
            ...
            <section
                ref={heroRef}
                className="relative flex min-h-screen items-center overflow-hidden px-16 py-20"
            >   
                <motion.div
                ...
                >
                    ...
                    <motion.h1
                        ...
                        className="mb-8  text-[clamp(3rem,8vw,6.5rem)] font-light leading-[1.05] text-white"
                    >
                        {[
                            "Brick by Brick,",
                            "We Build Your",
                    ...
                    >
                        {reviews.map((r, index) => (
                            <motion.div
                                ...
                                className="group relative min-h-[320px] overflow-hidden rounded-3xl border border-white/10 bg-white/[0.04] p-6 backdrop-blur-2xl"
                            >
                                <div className="absolute inset-0 opacity-0 transition duration-500 group-hover:opacity-100">
                                ...
                                <div className="mb-5 flex items-center justify-between">
                                    ...
                                    <div className="text-6xl font-light leading-none text-white/5">
                                        ”
                                    </div>
                                </div>
                                ...
                                <div className="mt-auto flex items-center justify-between border-t border-white/10 pt-5">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-emerald-400 via-cyan-400 to-blue-500 text-base font-semibold text-white shadow-lg shadow-emerald-500/20">
                                            {r.name.charAt(0)}
                                        </div>
            ...
            <section style={{ padding: '120px 24px', maxWidth: 760, margin: '0 auto' }}>
            ...
            <section style={{ position: 'relative', padding: '136px 24px', overflow: 'hidden' }}>
                ...
                <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger}
                    ...
                    <motion.h2 variants={fadeUp}
                        style={{  fontSize: 'clamp(2.6rem,6.5vw,5.8rem)', fontWeight: 300, color: C.text1, lineHeight: 1.06, marginBottom: 22 }}>
                    ...
                    <motion.div variants={fadeUp} custom={0.2}
                        ...
                        <Mag href="https://wa.me/918951639116">
